...
class DisentangledMultiheadAttention(nn.Module):
    ...
    This is a simplified version inspired by DeBERTa's content and position
    interactions inside attention.
    """
    ...
    def forward(self, x, mask=None, return_attention=False):
        ...
        # Scale by the number of active score terms.
        scale_factor = 3.0
...
class PositionalEncoding(nn.Module):
    ...
    rather than relying only on summed input position embeddings.
    """
